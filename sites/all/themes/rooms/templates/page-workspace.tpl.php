<?php
// $Id: page-workspace.tpl.php,v 1.26.2.3 2010/11/01 10:07:04 jliu Exp $
...
<body class="<?php print $classes; ?>">
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <?php if ($primary_links): ?>
    <div id="primary_links"><div class="section clearfix">
...
</div></div> <!-- /#page, /#page-wrapper /.bl /.br -->
</div></div></div> <!-- /.bl /.br /.tl /.tr -->
